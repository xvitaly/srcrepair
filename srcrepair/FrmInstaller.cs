                ...
                try
                {
                    ...
                    switch (Path.GetExtension(InstallPath.Text))
                    {
                        ...
                        case ".vtf": InstallSprayNow(InstallPath.Text); // Будем устанавливай спрей...
                            break;
                        case ".zip": CoreLib.ExtractFiles(InstallPath.Text, Path.Combine(CustomInstallDir, Properties.Settings.Default.UserCustDirName)); // Будем устанавливать содержимое архива...
                            break;
                    }
