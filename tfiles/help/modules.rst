...
Все файлы, отмеченные флажком около имени, будут удалены __без возможности восстановления__ если вы запустите очистку посредством нажатия кнопки **Выполнить очистку**. Если передумали, нажмите кнопку **Отмена**. В таком случае никаких действий предпринято не будет.
