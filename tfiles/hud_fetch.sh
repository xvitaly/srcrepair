...
fetch_hud http://huds.tf/toonhud/img/main.png http://www.mediafire.com/download/h2jygltops1uebs/toonhud_7-4.zip toonhud
...
fetch_hud http://huds.tf/evehud/img/main.png http://files.gamebanana.com/guis/eve_hud_v377.zip evehud
