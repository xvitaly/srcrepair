...
namespace srcrepair
{
    ...
    public partial class FrmStmClean : Form
    {
        ...
        private void EC_Execute_Click(object sender, EventArgs e)
        {
            ...
            // Запустим очистку...
            if (CleanDirs.Count > 0) { PluginManager.FormShowCleanup(CleanDirs, Text, AppStrings.PS_CleanupSuccess, BackUpDir, Properties.Resources.SteamProcName); } else { MessageBox.Show(AppStrings.AC_NoItemsSelected, Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Warning); }
        }
    }
}
